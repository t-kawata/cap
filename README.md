...
- 2025.06.17 現在、使用するモデルは `GPT-4.1-mini`, `Gemini-2.5-Flash`, `GPT-4o-mini` を想定して調整していますので、
...
- もちろん、GPT-4.1-mini, Gemini-2.5-Flash, GPT-4o-mini よりも上位のモデルも CAP で使用することができます。
- Claude 4 モデルも使用可能です。
- が、速度と精度のバランスは、シニアにとって GPT-4.1-mini, Gemini-2.5-Flash, GPT-4o-mini が最も適していると思います。
