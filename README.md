...
- 2025.06.16 現在、使用するモデルは `GPT-4.1-mini` を想定して調整していますので、
...
- もちろん、GPT-4.1-mini よりも上位のモデルも CAP で使用することができます。
- Claude 4 モデルも使用可能です。
- が、速度と精度のバランスは、シニアにとって `GPT-4.1-mini` が最も適していると思います。
- Gemini 2.5 Flash も選択肢ですが、`GPT-4.1-mini` の方が明らかな安定感です。
